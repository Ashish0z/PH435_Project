...
class Game{
    constructor(){
        ...
        var socket = io();
        socket.on('mpu_msg', (msg) => {
            console.log(msg)
            this.keyEvents(msg).bind(this);
    ...
    start(){
        ...
        this.fps = 5000/18; // saniyelik görüntü sayısı
